...
class Strings {
  static const Map<String, Map<AppLocale, String>> _values = {
    ...
    // Exercise UI
    'tapToReveal': {AppLocale.ru: 'Нажмите, чтобы перевернуть', AppLocale.en: 'Tap to reveal'},
    'iKnowIt': {AppLocale.ru: 'Знаю', AppLocale.en: 'I know it'},
    'iDontKnow': {AppLocale.ru: 'Не знаю', AppLocale.en: "I don't know"},
    'chooseTranslationPrompt': {AppLocale.ru: 'Выберите перевод', AppLocale.en: 'Choose the translation'},
    'chooseHanziPrompt': {AppLocale.ru: 'Выберите иероглиф', AppLocale.en: 'Choose the character'},
    'buildSentencePrompt': {AppLocale.ru: 'Соберите предложение', AppLocale.en: 'Build the sentence'},
    'typePinyinPrompt': {AppLocale.ru: 'Введите пиньинь', AppLocale.en: 'Type the pinyin'},
    'typePinyinHint': {
    ...
    'outOfHeartsBody': {
      AppLocale.ru: 'Подождите восстановления или повторите урок без ошибок в следующий раз.',
      AppLocale.en: 'Wait for hearts to refill, or come back and try a flawless run.',
    },
    'nextHeartIn': {AppLocale.ru: 'Следующее сердце через', AppLocale.en: 'Next heart in'},
    'backToLessons': {AppLocale.ru: 'К урокам', AppLocale.en: 'Back to lessons'},
    'lessonComplete': {AppLocale.ru: 'Урок завершён!', AppLocale.en: 'Lesson complete!'},
    'perfectLesson': {AppLocale.ru: 'Идеальный урок!', AppLocale.en: 'Perfect lesson!'},
    'reviewComplete': {AppLocale.ru: 'Повторение завершено!', AppLocale.en: 'Review complete!'},
    'mistakesToReview': {AppLocale.ru: 'Слова с ошибками', AppLocale.en: 'Words to review'},
    'continueLabel': {AppLocale.ru: 'Продолжить', AppLocale.en: 'Continue'},
    'newAchievement': {AppLocale.ru: 'Новое достижение!', AppLocale.en: 'New achievement!'},
    ...
    'streakDays': {AppLocale.ru: 'Текущая серия', AppLocale.en: 'Current streak'},
    'longestStreak': {AppLocale.ru: 'Рекордная серия', AppLocale.en: 'Longest streak'},
    'wordsLearned': {AppLocale.ru: 'Слов выучено', AppLocale.en: 'Words learned'},
    'accuracyAllTime': {AppLocale.ru: 'Точность (всё время)', AppLocale.en: 'Accuracy (all time)'},
    'accuracy7d': {AppLocale.ru: 'Точность (7 дней)', AppLocale.en: 'Accuracy (7 days)'},
    'achievements': {AppLocale.ru: 'Достижения', AppLocale.en: 'Achievements'},
    'streakCalendar': {AppLocale.ru: 'Календарь серии (30 дней)', AppLocale.en: 'Streak calendar (30 days)'},

    // Achievements
    'achStreak3': {AppLocale.ru: '3 дня подряд', AppLocale.en: '3-day streak'},
    'achStreak3Desc': {AppLocale.ru: 'Занимайтесь 3 дня подряд', AppLocale.en: 'Study 3 days in a row'},
    'achStreak7': {AppLocale.ru: '7 дней подряд', AppLocale.en: '7-day streak'},
    'achStreak7Desc': {AppLocale.ru: 'Занимайтесь 7 дней подряд', AppLocale.en: 'Study 7 days in a row'},
    'achStreak30': {AppLocale.ru: '30 дней подряд', AppLocale.en: '30-day streak'},
    'achStreak30Desc': {AppLocale.ru: 'Занимайтесь 30 дней подряд', AppLocale.en: 'Study 30 days in a row'},
    'achWords50': {AppLocale.ru: '50 слов', AppLocale.en: '50 words'},
    'achWords50Desc': {AppLocale.ru: 'Выучите 50 слов', AppLocale.en: 'Learn 50 words'},
    'achWords100': {AppLocale.ru: '100 слов', AppLocale.en: '100 words'},
    'achWords100Desc': {AppLocale.ru: 'Выучите 100 слов', AppLocale.en: 'Learn 100 words'},
    'achWords300': {AppLocale.ru: '300 слов', AppLocale.en: '300 words'},
    'achWords300Desc': {AppLocale.ru: 'Выучите 300 слов', AppLocale.en: 'Learn 300 words'},
    'achPerfectLesson': {AppLocale.ru: 'Идеальный урок', AppLocale.en: 'Perfect lesson'},
    ...
    'clearChatHistory': {AppLocale.ru: 'Очистить историю чата', AppLocale.en: 'Clear chat history'},
    'resetProgress': {AppLocale.ru: 'Сбросить прогресс', AppLocale.en: 'Reset progress'},
    'resetProgressConfirmTitle': {
      AppLocale.ru: 'Сбросить весь прогресс?',
      AppLocale.en: 'Reset all progress?',
    },
    'resetProgressConfirmBody': {
      AppLocale.ru: 'XP, серия, жизни и история повторений будут удалены безвозвратно. Словарь останется.',
      AppLocale.en: 'XP, streak, hearts, and review history will be permanently deleted. The word bank stays.',
    },
