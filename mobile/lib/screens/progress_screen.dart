...
class _ProgressScreenState extends State<ProgressScreen> {
  ...
  Future<void> _load() async {
    ...
    final acc7 =
        await repos.srs.accuracyPercent(within: const Duration(days: 7));
    final activeDays = await repos.srs
        .getActiveDaysSince(DateTime.now().subtract(const Duration(days: 30)));
            ...
            : RefreshIndicator(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    GridView.count(
                      ...
                      children: [
                        ...
                        _statTile(
                            ...
                            '${stats.longestStreak}'),
                        _statTile(context, Icons.menu_book, Colors.blue,
                            settings.t('wordsLearned'), '$_learnedWords'),
                        _statTile(
                            context,
                            Icons.percent,
                            Colors.teal,
                    ...
                    Text(settings.t('streakCalendar'),
                        style: Theme.of(context).textTheme.titleMedium),
                    const SizedBox(height: 8),
                    _calendar(),
                    const SizedBox(height: 24),
                    Text(settings.t('achievements'),
                        style: Theme.of(context).textTheme.titleMedium),
                    const SizedBox(height: 8),
                    Wrap(
                      spacing: 8,
  ...
  Widget _levelCard(
      BuildContext context, AppSettings settings, UserStats stats) {
        ...
        child: Column(
          ...
          children: [
            ...
            ClipRRect(
              ...
              child:
                  LinearProgressIndicator(value: goalProgress, minHeight: 10),
            ),
          ],
        ),
      ),
  ...
  Widget _statTile(BuildContext context, IconData icon, Color color,
